...
/*     */     }
/*     */     
/*  39 */     return String.valueOf(input.substring(0, start + SEQUENCE_HEADER.length())) + stringToColors(hiddenString) + input.substring(end, input.length());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  47 */     return String.valueOf(SEQUENCE_HEADER) + input + SEQUENCE_FOOTER;
/*     */   }
/*     */   
...
/* Location:              C:\Users\Bradley Methorst\Desktop\chatbubbles.jar!\me\TheTealViper\chatbubbles\HiddenStringUtils.class
