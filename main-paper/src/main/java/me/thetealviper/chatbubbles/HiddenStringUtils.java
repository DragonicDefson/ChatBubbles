...
public class HiddenStringUtils {
    private static final String SEQUENCE_HEADER = ChatColor.RESET.toString() + ChatColor.UNDERLINE + ChatColor.RESET;
    private static final String SEQUENCE_FOOTER = ChatColor.RESET.toString() + ChatColor.ITALIC + ChatColor.RESET;
    ...
    private static char[] byteToHex(byte b) {
        ...
        return new char[] {
            unsignedIntToHex(unsignedByte >> 4 & 0xF), unsignedIntToHex(unsignedByte & 0xF)
        };
    }
}